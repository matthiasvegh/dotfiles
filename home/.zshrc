...
plugins=(git screen extract zsh-syntax-highlighting colorize safe-paste history-substring-search autojump catimg command-not-found git-extras pip vagrant vundle)
